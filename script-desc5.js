...
headerImg.src = projects[4]["headerImg"];
headerImg.alt = projects[4]["headerImg-alt"];
title.textContent = projects[4]["name"];
workDescItem1.textContent = projects[4]["technologies"][0];
workDescItem2.textContent = projects[4]["technologies"][1];
workDescItem3.textContent = projects[4]["technologies"][2];
img1.src = projects[4]["image"];
img1.alt = projects[4]["workImg-alt"];
img2.src = projects[4]["image"];
img2.alt = projects[4]["workImg-alt"];
img3.src = projects[4]["image"];
img3.alt = projects[4]["workImg-alt"];
img4.src = projects[4]["image"];
img4.alt = projects[4]["workImg-alt"];
img5.src = projects[4]["image"];
img5.alt = projects[4]["workImg-alt"];
projDesc.textContent = projects[4]["description"];
