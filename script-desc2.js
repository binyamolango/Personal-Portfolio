...
headerImg.src = projects[1]["headerImg"];
headerImg.alt = projects[1]["headerImg-alt"];
title.textContent = projects[1]["name"];
workDescItem1.textContent = projects[1]["technologies"][0];
workDescItem2.textContent = projects[1]["technologies"][1];
workDescItem3.textContent = projects[1]["technologies"][2];
img1.src = projects[1]["image"];
img1.alt = projects[1]["workImg-alt"];
img2.src = projects[1]["image"];
img2.alt = projects[1]["workImg-alt"];
img3.src = projects[1]["image"];
img3.alt = projects[1]["workImg-alt"];
img4.src = projects[1]["image"];
img4.alt = projects[1]["workImg-alt"];
img5.src = projects[1]["image"];
img5.alt = projects[1]["workImg-alt"];
projDesc.textContent = projects[1]["description"];
