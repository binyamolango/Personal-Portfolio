...
headerImg.src = projects[5]["headerImg"];
headerImg.alt = projects[5]["headerImg-alt"];
title.textContent = projects[5]["name"];
workDescItem1.textContent = projects[5]["technologies"][0];
workDescItem2.textContent = projects[5]["technologies"][1];
workDescItem3.textContent = projects[5]["technologies"][2];
img1.src = projects[5]["image"];
img1.alt = projects[5]["workImg-alt"];
img2.src = projects[5]["image"];
img2.alt = projects[5]["workImg-alt"];
img3.src = projects[5]["image"];
img3.alt = projects[5]["workImg-alt"];
img4.src = projects[5]["image"];
img4.alt = projects[5]["workImg-alt"];
img5.src = projects[5]["image"];
img5.alt = projects[5]["workImg-alt"];
projDesc.textContent = projects[5]["description"];
