...
headerImg.src = projects[0]["headerImg"];
headerImg.alt = projects[0]["headerImg-alt"];
...
img1.src = projects[0]["image"];
img1.alt = projects[0]["workImg-alt"];
img2.src = projects[0]["image"];
img2.alt = projects[0]["workImg-alt"];
img3.src = projects[0]["image"];
img3.alt = projects[0]["workImg-alt"];
img4.src = projects[0]["image"];
img4.alt = projects[0]["workImg-alt"];
img5.src = projects[0]["image"];
img5.alt = projects[0]["workImg-alt"];
projDesc.textContent = projects[0]["description"];
