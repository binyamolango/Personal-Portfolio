...
headerImg.src = projects[2]["headerImg"];
headerImg.alt = projects[2]["headerImg-alt"];
title.textContent = projects[2]["name"];
workDescItem1.textContent = projects[2]["technologies"][0];
workDescItem2.textContent = projects[2]["technologies"][1];
workDescItem3.textContent = projects[2]["technologies"][2];
img1.src = projects[2]["image"];
img1.alt = projects[2]["workImg-alt"];
img2.src = projects[2]["image"];
img2.alt = projects[2]["workImg-alt"];
img3.src = projects[2]["image"];
img3.alt = projects[2]["workImg-alt"];
img4.src = projects[2]["image"];
img4.alt = projects[2]["workImg-alt"];
img5.src = projects[2]["image"];
img5.alt = projects[2]["workImg-alt"];
projDesc.textContent = projects[2]["description"];
